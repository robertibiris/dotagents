...
These fixtures compare two ways of making company, client, and project context available to Codex, Claude Code, Cursor, and GitHub Copilot without exposing sibling scopes by default.
...
- [Cursor nested rules](https://docs.cursor.com/context/rules-for-ai)
